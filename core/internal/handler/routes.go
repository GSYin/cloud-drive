	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				{
					Method:  http.MethodPost,
					Path:    "/user/file/storage",
					Handler: UserFileStorageHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/user/file/list",
				...
				{
					Method:  http.MethodPost,
					Path:    "/share/file/create",
					Handler: ShareFileCreateHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/shared/files/save",
					Handler: SharedFilesSaveHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/refresh/token",
					Handler: RefreshAuthTokenHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
